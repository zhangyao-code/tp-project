<?php /*a:3:{s:63:"/private/var/www/admin-project/app/admin/view/banner/index.html";i:1599814549;s:62:"/private/var/www/admin-project/app/admin/view/public//top.html";i:1599815783;s:65:"/private/var/www/admin-project/app/admin/view/public//bottom.html";i:1599814551;}*/ ?>
<!DOCTYPE html>
<html>
<head>
   <meta charset="utf-8">
...
<div style="margin-top: 10px;">
    <span class="layui-breadcrumb">
      <a href="javascript:;" class="menu_link" menu_link="/admin/Banner/index" menu_id="17">轮播管理</a>
      <a><cite>列表</cite></a>
    </span>
</div>
...
<script>
    ...
    layui.use(['table'], function(){
        ...
        table.render({
            id: 'tblId'
            ,elem: '#banner_list'
            ,url: '/admin/Banner/index' //数据接口
            ,page: true //开启分页
            ,cols: [ [ //表头
                { field:'id',sort: true, title: 'ID', width:'10%', align:'center'}
                ,{field: 'title', title: '轮播标题',width:'20%', align:'center'}
                ,{field: 'img_src', title: '图片', align:'center',width:'40%',templet: '#show_banner'}
                ,{field: 'type_title', title: '分类',width:'15%', align:'center'}
        ...
        var $ = layui.$, active = {
            add: function(){
                ...
                layer.open({
                    ...
                    shadeClose: true,
                    area: ['460px', '90%'],
                    content: '/admin/Banner/add' //iframe的url
                });
        ...
        table.on('tool(banner_list)', function(obj){
            ...
            if(obj.event === 'del'){
                layer.confirm('真的删除行么', function(index){
                    $.post("/admin/Banner/delete", {id:data.id}, function (data) {
                        if(data.code == 200){
                            table.reload('tblId', {
                                page: {
                                    curr: 1 //重新从第 1 页开始
                ...
                layer.open({
                    ...
                    shadeClose: true,
                    area: ['460px', '90%'],
                    content: '/admin/Banner/edit?id='+data.id //iframe的url
                });
            }
        });
