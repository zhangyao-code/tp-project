<?php /*a:3:{s:61:"/private/var/www/admin-project/app/admin/view/news/index.html";i:1599814551;s:62:"/private/var/www/admin-project/app/admin/view/public//top.html";i:1599815783;s:65:"/private/var/www/admin-project/app/admin/view/public//bottom.html";i:1599814551;}*/ ?>
<!DOCTYPE html>
<html>
<head>
   <meta charset="utf-8">
...
<div style="margin-top: 10px;">
    <span class="layui-breadcrumb">
      <a href="javascript:;" class="menu_link" menu_link="/admin/News/index" menu_id="22">新闻管理</a>
      <a><cite>列表</cite></a>
    </span>
</div>
    ...
    <div class="layui-form-item">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input class="layui-input" name="search" id="search_content" placeholder="标题/简介" autocomplete="off">
            </div>
        </div>
        <div class="layui-inline">
            <div class="layui-input-inline">
...
<table class="layui-hide" id="news_list" lay-filter="news_list"></table>
...
<script>
    ...
    layui.use(['table'], function(){
        ...
        var $ = layui.$, active = {
            add: function(){
                ...
                layer.open({
                    ...
                    shadeClose: true,
                    area: ['750px', '90%'],
                    content: '/admin/News/add' //iframe的url
                });
        ...
        //监听行工具事件
        table.on('tool(news_list)', function(obj){
            var data = obj.data;
            if(obj.event === 'del'){
                layer.confirm('真的删除行么', function(index){
                    $.post("/admin/News/delete", {id:data.id}, function (data) {
                        if(data.code == 200){
                            table.reload('tblId', {
                                page: {
                                    curr: 1 //重新从第 1 页开始
                ...
                layer.open({
                    ...
                    shadeClose: true,
                    area: ['750px', '90%'],
                    content: '/admin/News/edit?id='+data.id //iframe的url
                });
            }
        });
